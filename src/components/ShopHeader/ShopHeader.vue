<template>
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content" @click="isBulletin=!isBulletin">
    ...
    <div class="shop-header-discounts" v-if="info.name" @click="isSupports=!isSupports">
    ...
    <transition name='king' >
      <div class="shop-brief-modal" v-show="isBulletin">
        <div class="brief-modal-content">
          ...
          <div class="mask-footer" @click="isBulletin=!isBulletin">
            <span class="iconfont icon-close"></span>
          </div>
        </div>
        <div class="brief-modal-cover" @click="isBulletin=!isBulletin"></div>
      </div>
    </transition>
    <transition name='kiss'>
      <div class="activity-sheet" v-show="isSupports">
        <div class="activity-sheet-content">
          <h2 class="activity-sheet-title">优惠活动</h2>
          <ul class="list">
            <li
              class="activity-item"
              :class="colorArr[support.type]"
          ...
          <div class="activity-sheet-close" @click="isSupports=!isSupports">
            <span class="iconfont icon-close"></span>
          </div>
        </div>
        <div class="activity-sheet-cover" @click="isSupports=!isSupports"></div>
      </div>
    </transition>
  </div>
</template>
...
.shop-header
  ...
  .shop-brief-modal
    ...
    color #333
    &.king-enter-active,&.king-leave-active
      transition all .7s
    &.king-enter,&.king-leave-to
      opacity 0
    .brief-modal-cover
      position absolute
      width 100%
  ...
  .activity-sheet
    ...
    height 100%
    z-index 99
    &.kiss-enter-active, &.kiss-leave-active
